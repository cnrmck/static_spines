...
def sum_partial_sum(partial_sum, desired_denom = None):
    ...
    try:
        ...
        partial_sum = [psum for psum in partial_sum] # copying doesn't work (Jython)
...
def orders_for_n(n, b):
    ...
    10 in base 10 returns a tuple with only a '1' in it
    ...
    # think this had to do with Jython integration
    return tuple(orders)

def gen_point(num, base = 2):
    """
    ...
    (pi * 2) it returns that location as a tuple
